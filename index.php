...
<?php else: ?>
  <div class="grid md:grid-cols-2 gap-4 mb-8">
    ...
    <div class="bg-white rounded-2xl shadow hover:shadow-md transition p-6 border-l-4 border-green-500">
      ...
      <div class="flex gap-2">
        <?php if (isset($_SESSION['user_id'])): ?>
          <a href="vote.php?id=<?= $e['id'] ?>"
             class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white text-center
...
<div class="grid md:grid-cols-2 gap-4 mb-8">
  ...
  <div class="bg-white rounded-2xl shadow p-6 border-l-4 border-blue-400 opacity-80">
    <div class="flex items-start justify-between mb-2">
